        ...
        <div class="flex flex-col gap-8 max-w-5xl w-full mx-auto px-4 mb-16">
            ...
            <DemoCard
                ...
                <div class="lp-themed flex flex-row flex-wrap items-center gap-6">
                    ...
                    <p class="text-sm text-primary/60 max-w-md">
...
fn PopoverTrigger(selected: Signal<Option<LucideGlyph>>) -> impl IntoView {
    view! {
        <button class="flex items-center justify-between gap-3 px-4 py-2.5
                       w-[780px] max-w-full
                       bg-secondary border border-primary/10 rounded-md
...
fn SelectionReadout(selected: Signal<Option<LucideGlyph>>) -> impl IntoView {
    view! {
        <div class="flex items-center gap-4 pt-3 border-t border-primary/10">
        ...
        <div class="max-w-5xl w-full mx-auto px-4 mb-16">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {features.iter().map(|(glyph, title, desc)| {
                    let g = *glyph;
                    view! {
                        <div class="flex flex-col gap-2 p-5 rounded-lg
                                    bg-primary/5 border border-primary/10
                                    hover:border-highlight/40 transition-colors">
                            <div class="flex items-center justify-center w-10 h-10
                                        rounded-md bg-secondary text-highlight mb-1">
