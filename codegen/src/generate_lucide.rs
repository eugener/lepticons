...
fn main() {
    ...
    writeln!(
        file,
        r#"
    use strum_macros::{{EnumProperty,EnumIter,EnumString,IntoStaticStr}};
    "#
    )
    ...
    writeln!(
        file,
        "#[derive(EnumIter, EnumProperty, EnumString, IntoStaticStr, PartialEq, Eq, PartialOrd, Ord, Hash, Debug, Clone, Copy)]"
    )
